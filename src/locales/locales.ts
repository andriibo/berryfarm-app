...
export const strings = new LocalizedStrings({
  ru: {
    ...
    minValue01: 'Минимальное значение 0.1',
    maxValue999999: 'Максимальное значение 999999.99',
    minValue1: 'Минимальное значение 1',
    scanQrCode: 'Сканировать QR код',
    goToAssignQrCode: 'Перейти к выдаче QR кода',
    ...
    quality: 'Качество',
    package: 'Упаковка',
    numberOfBoxes: 'Кол-во ящиков, шт.',
    product: 'Продукт',
